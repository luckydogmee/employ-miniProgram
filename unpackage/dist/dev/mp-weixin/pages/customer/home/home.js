...
/* harmony import */ var _home_vue_vue_type_template_id_4f593838___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./home.vue?vue&type=template&id=4f593838& */ 118);
...
var _user = _interopRequireDefault(__webpack_require__(/*! @/models/user.js */ 93));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
      ...
      uni.login({
        ...
        success: function success(response) {
          if (response.errMsg === 'login:ok') {
            ...
            userModel.wxLogin(encryptedData, ivData, response.code).then(function (res) {
              // 判断是成功了
              if (res.data.code == 0) {
                // 将token存入缓存中
